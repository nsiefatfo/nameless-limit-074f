...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/nameless-limit-074f
```

A live public deployment of this template is available at [https://nameless-limit-074f.templates.workers.dev](https://nameless-limit-074f.templates.workers.dev)
